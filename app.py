...
model_path2 = 'xcep.h5' # load .h5 Model
...
def model_predict2(image_path,model):
    ...
    if result == 1:
        return "The Patient is Diagnosis with Parkinson Disease based on input Spiral Image","result.html"        
    elif result == 0:
        return "The Patient is Not Diagnosis with Parkinson Disease based on input Spiral Image","result.html"
